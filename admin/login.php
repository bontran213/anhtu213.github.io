...
<head>
  ...
  <title>AT Shop - Admin</title>

  <link rel="shortcut icon" href="assets/images/favicon.png" />
      <script src="/ATshop/webroot/jquery/jquery.js"></script>
  <link rel="stylesheet" href="template/css/sb-admin-2.min.css">
  <link href="/ATshop/webroot/font/Font Awesome/css/all.min.css" rel="stylesheet" type="text/css">
          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block ">
                  <img src="../webroot/img/AT.png" width="500" alt="">
              </div>
              <div class="col-lg-6">
                <div class="p-5">

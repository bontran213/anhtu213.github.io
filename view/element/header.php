			...
			<ul class=" menu-l">
				<li class="w"><a href="index.php" title="">Danh Mục <i class="fa fa-angle-down"></i></a>
                    ...
                    while ($row=mysqli_fetch_array($rss)) { ?>	
						<li><a href="/ATshop/index.php?view=dksanpham&madm=<?php echo $row['MaDM'];?>&t=<?php echo $row['TenDM'] ?>" ><?php echo $row['TenDM'];?></a></li>
					<?php  } ?>
					</ul>
				</li>
				<li class="a2 w"></li>
				<li class="w"><a href="index.php" title="">Sản Phẩm <i class="fa fa-angle-down"></i></a>
                    ...
                    $rss=mysqli_query($conn,$dmsql);                 
                    while ($row=mysqli_fetch_array($rss)) { ?>
						<li><a href="/ATshop/index.php?view=dksanpham&mancc=<?php echo $row['MaNCC'];?>&t=<?php echo $row['TenNCC'] ?>" ><?php echo $row['TenNCC'];?></a></li>
					 <?php  } ?>
					</ul>
				</li>
				<li class="a2 w"></li>
